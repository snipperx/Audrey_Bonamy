			...
			<div class="<?php echo esc_attr($this->field->alias); ?>">
				...
				<div class="settings-font-options-dialog">
					<div class="toogle-font-select-container">
						...
						<input class="button" type="button" value="<?php _e('Apply', 'framework'); ?>" name="<?php echo esc_attr($this->field->alias);?>_save"/>
						<input class="button" type="button" value="<?php _e('Cancel', 'framework'); ?>" name="<?php echo esc_attr($this->field->alias);?>_cancel"/>
