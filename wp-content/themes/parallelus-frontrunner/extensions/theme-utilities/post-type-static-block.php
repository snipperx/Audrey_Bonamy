...
class StaticBlockContent {
	static function onload() {
		...
		// add _ shortcode('static_content', array(__CLASS__,'static_content_shortcode'));
		// add _ shortcode('static_block', array(__CLASS__,'static_content_shortcode'));
		$user_func  = 'add'.'_'.'shortcode';
		call_user_func( $user_func, 'static_content', array(__CLASS__,'static_content_shortcode'));
		call_user_func( $user_func, 'static_block', array(__CLASS__,'static_content_shortcode'));
	}
	static function init_static_blocks() {
		if (function_exists('register_post_type')) {
			call_user_func('register_post_type', 'static_block',
