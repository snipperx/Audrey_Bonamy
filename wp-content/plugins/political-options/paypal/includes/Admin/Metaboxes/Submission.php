...
final class PoliticalOptions_PayPal_Admin_Metaboxes_Submission extends NF_Abstracts_SubmissionMetabox
{
    ...
    public function render_metabox( $post, $metabox )
    {
        ...
        PoliticalOptions_PayPal::template( 'admin-metaboxes-submission.html.php', $data );
    }
}