 ...
 */
class PoliticalOptions_PayPal_PaymentGateway extends NF_Abstracts_PaymentGateway
{
    ...
    public function process( $action_settings, $form_id, $data )
    {
        ...
        $api = PoliticalOptions_PayPal()->api( $action_settings[ 'ppe_sandbox' ] );
        ...
        if( isset( $data[ 'resume' ] ) ){
            ...
            if ( $this->is_success( $response ) ) { //Request successfully
                ...
                // fixes issue with success message not displaying
                if ( isset(Ninja_Forms()->merge_tags[ 'paypal_express' ]) && Ninja_Forms()->merge_tags[ 'paypal_express' ] !== NULL ) {
        ...
        if ( $this->is_success( $response ) ) { //Request successfully
            ...
            ob_start();
            PoliticalOptions_PayPal::template( 'spinner.html' );
    ...
    public function enqueue_scripts( $data )
    {
        ...
        wp_enqueue_script('nf-paypal-express-debug', PoliticalOptions_PayPal::$url . 'assets/js/debug.js', array( 'nf-front-end' ) );
        wp_enqueue_script('nf-paypal-express-response', PoliticalOptions_PayPal::$url . 'assets/js/error-handler.js', array( 'nf-front-end' ) );
    }
...
} // END CLASS PoliticalOptions_PayPal_PaymentGateway
